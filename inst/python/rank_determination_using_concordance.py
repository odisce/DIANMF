...
# reticulate::py_install("sklearn.decomposition")
# reticulate::py_install("scipy.cluster.hierarchy")
...
print("Python script executed 22222222")
...
print("Python script executed 33333333")
