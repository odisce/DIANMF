...
The first peak does not have specific MS2 fragments, so we will work with the second peak and extract its' MS2 raw matrix $X$ and elution profiles matrix $H$ from the MS2_features object.
