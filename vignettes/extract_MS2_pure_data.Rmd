...
Here, to shorten the vignette running time, we will process the 1st 10 peaks. we use the <span style="background-color: rgba(169, 169, 169, 0.4);">dia_nmf.f()</span> function with <span style="background-color: rgba(169, 169, 169, 0.4);">ms_level = "MS2"</span>.
...
MS1_pure_spectra <- extrcat_pureSpect( features = MS2_features, spec_level = 'MS1' )
MS2_pure_spectra <- extrcat_pureSpect( features = MS2_features, spec_level = 'MS2' )
```
