...
MS2_features <- dia_nmf.f( mzML_path = file,
                       ms_level = "MS2",
                       peaks_by_xcms = TRUE, ms1_peaks = NULL, d.out = "~/DIA_NMF_R_package/dianmf",
...
p <- plot_ms2spectra_detailes(ms2_spectrum = ms2_pure_spectrum, ms2_specific_spectrum = ms2_pure_spectrum_specific)
p
```
